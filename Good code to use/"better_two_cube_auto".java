...
public class Robot extends IterativeRobot {
    ...
    int startpos = 1; //startpos 1 is far right, startpos 2 is middle right, startpos 3 is far left
...
public void getCube() {
	leftElevatorMotor.set(ControlMode.PercentOutput, -.35);
	rightElevatorMotor.set(ControlMode.PercentOutput, .35);
	Timer.delay(1.5);
	...
	Solenoid3.set(false);
	intakeBags.set(ControlMode.PercentOutput, 0);
	leftElevatorMotor.set(ControlMode.PercentOutput, .5);
	rightElevatorMotor.set(ControlMode.PercentOutput, -.5);		
	leftMotor1.set(ControlMode.PercentOutput, .5);
	leftMotor2.set(ControlMode.PercentOutput, .5);
	rightMotor1.set(ControlMode.PercentOutput, -.5);
	rightMotor2.set(ControlMode.PercentOutput, -.5);
